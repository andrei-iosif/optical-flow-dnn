...
python -u train.py --name train_raft_viper_1 --stage viper --validation viper --checkpoint_out ../checkpoints/raft_viper_1 --restore_ckpt ../checkpoints/raft/raft-things.pth --gpus 0 --num_steps 50000 --batch_size 6 --lr 0.0001 --image_size 288 960 --wdecay 0.00001 --gamma=0.85 --seed 1234
