...
# python -u train.py --name overfit_raft_viper_100_sample_seed_0_all_iters_semantic_loss_V0 --num_overfit_samples 100 --val_freq 500 --restore_ckpt ../models/raft_original_models/raft-things.pth --checkpoint_out=../checkpoints/debug --stage viper --validation kitti --gpus 0 --num_steps 2000 --batch_size 6 --lr 0.0001 --image_size 288 960 --wdecay 0.0001 --seed 0 --debug_iter --semantic_loss true

# python -u train.py --name overfit_raft_viper_100_sample_seed_0_semantic_loss_V0_disable_all_iters --num_overfit_samples 100 --val_freq 500 --restore_ckpt ../models/raft_original_models/raft-things.pth --stage viper --validation kitti --gpus 0 --num_steps 2000 --batch_size 6 --lr 0.0001 --image_size 288 960 --wdecay 0.0001 --seed 0 --semantic_loss true

# python -u train.py --name overfit_raft_viper_100_sample_seed_0_all_iters_semantic_loss_lr_1e-5 --num_overfit_samples 100 --val_freq 500 --restore_ckpt ../models/raft_original_models/raft-things.pth --stage viper --validation kitti --gpus 0 --num_steps 2000 --batch_size 6 --lr 1e-5 --image_size 288 960 --wdecay 0.0001 --seed 0 --debug_iter --semantic_loss true

# python -u train.py --name overfit_raft_viper_100_sample_seed_1234_all_iters_semantic_loss --num_overfit_samples 100 --val_freq 500 --restore_ckpt ../models/raft_original_models/raft-things.pth --stage viper --validation kitti --gpus 0 --num_steps 5000 --batch_size 6 --lr 1e-4 --image_size 288 960 --wdecay 0.0001 --seed 1234 --debug_iter --semantic_loss true

# python -u train.py --name overfit_raft_viper_100_sample_seed_1234_all_iters_semantic_loss_V0 --num_overfit_samples 100 --val_freq 500 --restore_ckpt ../models/raft_original_models/raft-things.pth --stage viper --validation kitti --gpus 0 --num_steps 5000 --batch_size 6 --lr 1e-4 --image_size 288 960 --wdecay 0.0001 --seed 1234 --debug_iter --semantic_loss true

python -u train.py --name overfit_raft_viper_100_sample_seed_0_all_iters_semantic_loss_FIXED --num_overfit_samples 100 --val_freq 500 --restore_ckpt ../models/raft_original_models/raft-things.pth --stage viper --validation kitti --gpus 0 --num_steps 5000 --batch_size 6 --lr 1e-4 --image_size 288 960 --wdecay 0.0001 --seed 0 --debug_iter --semantic_loss true
