...
def inputs_visu(img_1, gt_flow, sample_id, valid_flow_mask=None, semseg_gt=None, output_path=None):
    """
    ...
    if output_path is not None:
        ...
        fig.savefig(os.path.join(output_path, str(sample_id) + '.png'), bbox_inches="tight", pad_inches=0.3, dpi=100)
        plt.close()
