...
def run(args):
    ...
    for sample_id in range(len(dataset)):
        ...
        # img_1, _, gt_flow, valid_flow_mask, flow_uncertainty = dataset[sample_id]
        ...
        inputs_visu(img_1, gt_flow, sample_id, valid_flow_mask=valid_flow_mask, output_path=args.out)
